...
const PayApprove = props => {
  const { approvalRequestCreds, setApprovalRequestCreds, pending, setPending } =
    props
  ...
  const handleSubmit = async e => {
    ...
    if (
      approvalRequestCreds.CNIC === e.target.CNIC.value &&
      approvalRequestCreds.firstName === e.target.firstName.value.toLowerCase()
    ) {
      ...
      const res = await Api.post('requestapproval', formData, {
